...
for(n = 1; n <= N1; n++){
  ...
  for(m = 1; m <= 5; m++){
    ;
    tv[ m ] =  v[ m][ i][ j][ k ] - omega * (  ldz[ m][ 1][ n ] * v[ 1][ i][ j][ k-1 ] + ldz[ m][ 2][ n ] * v[ 2][ i][ j][ k-1 ] + ldz[ m][ 3][ n ] * v[ 3][ i][ j][ k-1 ] + ldz[ m][ 4][ n ] * v[ 4][ i][ j][ k-1 ] + ldz[ m][ 5][ n ] * v[ 5][ i][ j][ k-1 ]  );
    ;
  }
  ;
  ;
  for(m = 1; m <= 5; m++){
    ;
    tv[ m ] =  tv[ m ] - omega * ( ldy[ m][ 1][ n ] * v[ 1][ i][ j-1][ k ] + ldx[ m][ 1][ n ] * v[ 1][ i-1][ j][ k ] + ldy[ m][ 2][ n ] * v[ 2][ i][ j-1][ k ] + ldx[ m][ 2][ n ] * v[ 2][ i-1][ j][ k ] + ldy[ m][ 3][ n ] * v[ 3][ i][ j-1][ k ] + ldx[ m][ 3][ n ] * v[ 3][ i-1][ j][ k ] + ldy[ m][ 4][ n ] * v[ 4][ i][ j-1][ k ] + ldx[ m][ 4][ n ] * v[ 4][ i-1][ j][ k ] + ldy[ m][ 5][ n ] * v[ 5][ i][ j-1][ k ] + ldx[ m][ 5][ n ] * v[ 5][ i-1][ j][ k ] );
    ;
  }
  ;
  for(m = 1; m <= 5; m++){
