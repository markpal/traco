...
for(j = N1; j <= N2; j++){
  for(i = N3; i <= N4; i++){
    ...
    ;
    d[5][2][i][j] = dt * 2.0 * ( tx1 * ( r43*c34 - c1345 ) + ty1 * (     c34 - c1345 ) + tz1 * (     c34 - c1345 ) ) * tmp2 * u[2][i][j][k];
    d[5][3][i][j] = dt * 2.0 * ( tx1 * ( c34 - c1345 ) + ty1 * ( r43*c34 -c1345 ) + tz1 * ( c34 - c1345 ) ) * tmp2 * u[3][i][j][k];
    d[5][4][i][j] = dt * 2.0 * ( tx1 * ( c34 - c1345 ) + ty1 * ( c34 - c1345 ) + tz1 * ( r43*c34 - c1345 ) ) * tmp2 * u[4][i][j][k];
    ...
    a[2][2][i][j] =  dt * tx2 * ( ( 2.0 - c2 ) * ( u[2][i+1][j][k] * tmp1 ) ) - dt * tx1 * ( r43 * c34 * tmp1 ) - dt * tx1 * dx2;
    ...
    a[4][5][i][j] = 0.0;
    ;
    a[5][1][i][j] = dt * tx2 * ( ( c2 * 2.0 * qs[i+1][j][k] - c1 * u[5][i+1][j][k] ) * ( u[2][i+1][j][k] * tmp2 ) ) - dt * tx1 * ( - ( r43*c34 - c1345 ) * tmp3 * ( u[2][i+1][j][k]**2 ) - (     c34 - c1345 ) * tmp3 * ( u[3][i+1][j][k]**2 ) - (     c34 - c1345 ) * tmp3 * ( u[4][i+1][j][k]**2 ) - c1345 * tmp2 * u[5][i+1][j][k] );
    ...
    c[4][4][i][j] = dt * tz2 * ( 2.0 - c2 ) * ( u[4][i][j][k+1] * tmp1 ) - dt * tz1 * ( r43 * c34 * tmp1 ) - dt * tz1 * dz4;
    c[4][5][i][j] = dt * tz2 * c2;
    ;
    c[5][1][i][j] = dt * tz2 * ( ( c2 * 2.0 * qs[i][j][k+1] - c1 * u[5][i][j][k+1] ) * ( u[4][i][j][k+1] * tmp2 ) ) - dt * tz1 * ( - ( c34 - c1345 ) * tmp3 * (u[2][i][j][k+1]**2) - ( c34 - c1345 ) * tmp3 * (u[3][i][j][k+1]**2) - ( r43*c34 - c1345 )* tmp3 * (u[4][i][j][k+1]**2) - c1345 * tmp2 * u[5][i][j][k+1] );
