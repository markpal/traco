...
for(n = 1; n <= N1; n++){
  ...
  ;
  for(m = 1; m <= 5; m++){
    tv[ m ] = omega * (  udz[ m][ 1][ n ] * v[ 1][ i][ j][ k+1 ] + udz[ m][ 2][ n ] * v[ 2][ i][ j][ k+1 ] + udz[ m][ 3][ n ] * v[ 3][ i][ j][ k+1 ] + udz[ m][ 4][ n ] * v[ 4][ i][ j][ k+1 ] + udz[ m][ 5][ n ] * v[ 5][ i][ j][ k+1 ] );
  }
  ;
  ;
  for(m = 1; m <= 5; m++){
    tv[ m ] = tv[ m ] + omega * ( udy[ m][ 1][ n ] * v[ 1][ i][ j+1][ k ] + udx[ m][ 1][ n ] * v[ 1][ i+1][ j][ k ] + udy[ m][ 2][ n ] * v[ 2][ i][ j+1][ k ] + udx[ m][ 2][ n ] * v[ 2][ i+1][ j][ k ] + udy[ m][ 3][ n ] * v[ 3][ i][ j+1][ k ] + udx[ m][ 3][ n ] * v[ 3][ i+1][ j][ k ] + udy[ m][ 4][ n ] * v[ 4][ i][ j+1][ k ] + udx[ m][ 4][ n ] * v[ 4][ i+1][ j][ k ] + udy[ m][ 5][ n ] * v[ 5][ i][ j+1][ k ] + udx[ m][ 5][ n ] * v[ 5][ i+1][ j][ k ] );
  }
  ;
  for(m = 1; m <= 5; m++){
    tmat[ m][ 1 ] = d[ m][ 1][ n ];
