...
class uad_RunnableThread implements Runnable {
	...
	public TextView tv;
	public uad_RunnableThread() {
	}
	public uad_RunnableThread(String threadName, int z) {
			...
			if(id==0) 
				...
				if (N3 >= 1 && N2 >= 2 && N4 >= 1) {
					  for(t1 = lb; t1 <= ub; t1++) {
					    for(t3 = 1; t3 <= N3; t3++) {
					      for(t4 = 1; t4 <= N4; t4++) {
						tm2[t4][t3][t1] = tm2[t4][t3][t1]+u[t4][1][t1]*wdtdr[1][t3];
					        if (t1 >= 1 && t4 >= 1 && t4 <= N4 && t3 >= 1 && t3 <= N3 && N1 >= t1) {
					          for(t2 = 2; t2 <= N2; t2++) {
						    tm2[t4][t3][t1] = tm2[t4][t3][t1]+u[t4][t2][t1]*wdtdr[t2][t3];
...
public class UAD4_loop
{
	public String output;
	public long time;
	
	int N1, N2, N3, N4, DIM1, DIM2, DIM3;
	
	int[][][] tm2;
	int[][][] u;
	int[][] wdtdr;
	
	public UAD4_loop(int num_proc, int iter)
	{
		   N1 = iter;  //100 
		   N2 = N1;
		   N3 = N1;
	...
	void seq()
	{
		long start = System.currentTimeMillis();
	       ...
	       uad_RunnableThread r3 = new uad_RunnableThread();
	       
	       r3.u = u; r3.tm2 = tm2; r3.wdtdr = wdtdr;
	...
	void par()
	{
	       ...
	       uad_RunnableThread r1 = new uad_RunnableThread();
	       

	       r1.u = u; r1.tm2 = tm2; r1.wdtdr = wdtdr;
	       ...
	       uad_RunnableThread r2 = new uad_RunnableThread();

	       r2.u = u; r2.tm2 = tm2; r2.wdtdr = wdtdr;
