...
int main(int argc, char *argv[]) {
  ...
  int CXM = CXM;
  int n = CZ;
	 #pragma acc data copyinout(HZ[0:n*n*n],Bza[0:n*n*n]) copynin(Ry[0:n*n],AXx[0:n*n],Ex[0:n*n*n],Ey[0:n*n*n],Hz[0:n*n*n],czm[0:n],czp[0:n],cxmh[0:n],cxph[0:n],cymh[0:n],cyph[0:n],mui,ch,n,CZ,CXM,CYM, iz,iy,ix,czm_iz,czp_iz,cymh_iy,cyph_iy,clf,tmp)
	{
