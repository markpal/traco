...
*/
for( c1 = 0; c1 < N + floord(N - 1, 32) - 1; c1 += 1)
  for( c3 = max(0, floord(-N + 32 * c1, 1024) + 1); c3 <= c1 / 33; c3 += 1)
    for( c4 = 0; c4 <= 1; c4 += 1) {
      if (c4 == 1) {
        for( c7 = max(-N + 32 * c1 - 1024 * c3 + 1, -N + 32 * c3 + 2); c7 <= min(0, -N + 32 * c1 - 1024 * c3 + 32); c7 += 1)
          for( c9 = 32 * c3 - c7 + 1; c9 <= min(N - 1, 32 * c3 - c7 + 32); c9 += 1)
            for( c10 = max(0, 32 * c3 - c7 - c9 + 2); c10 <= 1; c10 += 1) {
              if (c10 == 1) {
                S[-c7][c9] = S[-c7][c9]+ S[-c7+1][c9-1];
              } else {
                if (N + 1024 * c3 + c7 >= 32 * c1 + 2)
        ...
        for( c5 = 0; c5 <= c3; c5 += 1)
          for( c7 = max(-N + 32 * c1 - 1024 * c3 + 1, -N + 31 * c1 - 991 * c3 + 2); c7 <= min(0, -N + 32 * c1 - 1024 * c3 + 32); c7 += 1) {
            if (c3 >= c5 + 1 && N + 1024 * c3 + c7 >= 32 * c1 + 2) {
              for( c11 = 32 * c5; c11 <= 32 * c5 + 31; c11 += 1)
                S[-c7][32*c3-c7+1] = S[-c7][c11+-c7] + S[c11+-c7+1][32*c3-c7+1]+ S[-c7][32*c3-c7+1];
            } else if (c3 >= c5 + 1 && N + 1024 * c3 + c7 == 32 * c1 + 1) {
              for( c9 = N - 32 * c1 + 1056 * c3; c9 <= N - 32 * c1 + 1056 * c3 + 31; c9 += 1)
                for( c11 = 32 * c5; c11 <= 32 * c5 + 31; c11 += 1)
                  S[N-32*c1+1024*c3-1][c9] = S[N-32*c1+1024*c3-1][c11+N-32*c1+1024*c3-1] + S[c11+N-32*c1+1024*c3-1+1][c9]+ S[N-32*c1+1024*c3-1][c9];
            } else if (N + 1024 * c3 + c7 >= 32 * c1 + 2) {
              S[-c7][32*c3-c7+1] = S[-c7][32*c3+-c7] + S[32*c3+-c7+1][32*c3-c7+1]+ S[-c7][32*c3-c7+1];
            } else
              for( c9 = N - 32 * c1 + 1056 * c3; c9 <= N - 32 * c1 + 1056 * c3 + 31; c9 += 1)
                S[N-32*c1+1024*c3-1][c9] = S[N-32*c1+1024*c3-1][32*c3+N-32*c1+1024*c3-1] + S[32*c3+N-32*c1+1024*c3-1+1][c9]+ S[N-32*c1+1024*c3-1][c9];
          }
    }
