...
/************************UWAGA**************************/
//tutaj beda przechowywane przechwycone relacje z Petita
//deklaracja globalna aby nie bawic sie z przekazywaniem i przerabianiem funkcji petita
extern Tuple<Relation> petitRelations;   // Tablica liczy sie od 1
...
extern Tuple<bool> petitRelationsVecType;
//pozizej zbior zawierajacy wektory zaleznosci dla odpowiednich relacji
extern Tuple<Relation> petitDepVector;
//ponizej struktura do przechowywania numeru wierszy instukcji
//miedzy którymi zachodzi zale¿noæ
extern Tuple<int> petitFrom;
extern Tuple<int> petitTo;
extern Tuple<char *> petitRelationsType;
////////////////////////////////////////
extern Tuple<std::string> petitLine;
extern Tuple<char *> petitVar;
